export const credentials = {
	...
	private_key_id: process.env.private_key_id_calendar.replace(/\\n/gm, "\n"),
	private_key: process.env.private_key_calendar.replace(/\\n/gm, "\n"),
	client_email: "calendarconnect@lakiconnect.iam.gserviceaccount.com",
	client_id: process.env.client_id_calendar.replace(/\\n/gm, "\n"),
